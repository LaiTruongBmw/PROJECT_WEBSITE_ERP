...
function BodyInit()
{
	...
	dso_lst_stgsau00101_0.Call("SELECT");
}
function OnSearch()
{
	dso_grd_stgsau00101_0.Call("SELECT");
}
...
function doSelect(sender,event)
{
 ...
 {
	if(obj.id =='dso_lst_stgsau00101_0')
	{
		OnSearch();
	 }	
 }
...
<gw-data id="dso_lst_stgsau00101_0" onreceive="OnDataReceive(this)"> 
		<xml> 
			<!-- procedure="gasp.ga_sel_wsyau00001_list_org" -->
			<dso type="list" function="st_hr_sel_lst_stgsau00101_0" > 
				<data-inputs>
...
<gw-data id="dso_grd_stgsau00101_0"  onreceive="OnDataReceive(this)" > 
    <xml> 
   		 <dso type="grid" parameter="" function="st_hr_sel_grd_stgsau00101_0" procedure=""   > 
            <data-inputs> 
                <data-input bind="txtClient" ></data-input>
...
<table  align="center" width="100%" height="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr height="8%">
    <td colspan=10 width="10%"><gw-label id="lbl_lang_Client"  >Client:</gw-label></td>
	<td colspan=20 width="20%">
		<gw-input id="txtClient" csstype="mandatory" styles="width: 100%;" />
	</td>
    ...
    <td colspan=5 align="right" width="5%" style="padding-left:1px;">
    	<!-- <gw-button img="search" alt="Dictionary" id="Dictionary" text="Dictionary" onclick="Dictionary()" /> -->
