...
function OnAddNew(p_obj)
{
    if(p_obj=="MASTER")
    {
        ...
        //grdMasterCode.GetGridControl().TopRow=grdMasterCode.RowCount-1;
...
<!--  BEGIN DSO  -->
<!------------------data control--------------------------->
<ts-data id="datMasterCode" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="grid"  parameter="PK,SEQ,ID,NAME,USE_YN,REMARK,NUM1NN,NUM2NN,NUM3NN,NUM4NN,NUM5NN,NUM6NN,NUM7NN,NUM8NN,CHA1NM,CHA2NM,CHA3NM,CHA4NM,CHA5NM,CHA6NM,CHA7NM,CHA8NM,SYS_YN,ID_MAP,TABLE_NAME,COLUMN_NAME" function="sel_stgshr00010_01" procedure="upd_stgshr00010_01">
...
<!---------------------------------------------------------->
<ts-data id="datDetailCode" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="grid"  parameter="PK,MASTER_PK,SEQ,CODE,CODE_NM,CODE_KNM,CODE_FNM,NUM1NN,NUM2NN,NUM3NN,NUM4NN,NUM5NN,NUM6NN,NUM7NN,NUM8NN,CHA1NM,CHA2NM,CHA3NM,CHA4NM,CHA5NM,CHA6NM,CHA7NM,CHA8NM,USE_YN,REMARK,COMPANY" function="sel_stgshr00010_02" procedure="upd_stgshr00010_02">
...
<ts-data id="datListChar_5" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="array" function="sel_stgshr00010_03" > 
			<data-inputs>
            ...
            <td>
               <table width="100%"  id="tblUpper" style="height:5%" border=1 cellpadding="0" cellspacing="0">
                    <tr style="border:0;width:100%;height:100%" valign="top" >
                        ...
                        <td colspan="5" style="border:0;width:5%" align="right" valign="middle">ID
                        </td>
                        ...
                        <td colspan="8" width="8%" style="border:0;" align="right" >
                            <ts-button img="new" id="ibtnAdd_M"   alt="Add"  onclick="OnAddNew('MASTER')" imgtype="0">New</ts-button>
                        </td>
                         <td colspan="8" width="8%" style="border:0;" align="right" >
                        ...
                        <td colspan=100 style="width:100%;height:100%;"> 
                             <ts-grid id="grdMasterCode" rowClick="ShowDetail(sender,event)">
                                 <columns>
                                     ...
                                     <column text="SEQ" datafield="SEQ" columntype="textbox" width="100"></column>
                                     <column text="ID" datafield="ID" columntype="textbox" width="150"></column>
                                     <column text="NAME" datafield="NAME" columntype="textbox" width="200"></column>
                                     <column text="USE" datafield="USE_YN" cellsalign="center" columntype="checkbox" width="90"></column>
                                     <column text="REMARK" datafield="REMARK" columntype="textbox" width="100"></column>
                                     ...
                                     <column text="SYS Y/N" datafield="SYS_YN" cellsalign="center" columntype="checkbox" width="70"></column>
                                     <column text="ID MAP" datafield="ID_MAP" columntype="textbox" width="150"></column>
                                     <column text="TABLE NAME" datafield="TABLE_NAME" columntype="textbox" width="150"></column>
                                     <column text="COLUMN NAME" datafield="COLUMN_NAME" columntype="textbox" width="150"></column>
                                 </columns>
                             </ts-grid>
                         </td>
                    </tr>
               ...
               <table width="100%" id="tblDetail" style="height:45%" border=1 cellpadding="0" cellspacing="0">
                    <tr style="border:0;width:100%;height:5%" valign="center" >
                        ...
                        <td colspan="5" width="5%" style="border:0;" align="right" >
                         <ts-button img="new" id="ibtnAdd_D"   alt="Add"  onclick="OnAddNew('DETAIL')" imgtype="0">New</ts-button>
                        </td>
                         <td colspan="8" width="8%" style="border:0;" align="right" >
                    ...
                    <tr style="border:1;width:100%;height:95%" valign="top">
                        <td colspan=100 style="width:100%;height:100%;"> 
                            <ts-grid id="grdDetailCode" rowClick="CheckButton(this)">
                                 <columns>
                                     <column text="PK" datafield="PK" hidden="true" columntype="textbox" width="100"></column>
                                     <column text="Master PK" datafield="MASTER_PK"  columntype="textbox" width="100"></column>
                                     ...
                                     <column text="CHA 7 Name" datafield="CHA7NM" columntype="textbox" width="150"></column>
                                     <column text="CHA 8 Name" datafield="CHA8NM" columntype="textbox" width="150"></column>
                                     <column text="USE" datafield="USE_YN" cellsalign="center" columntype="checkbox" width="70"></column>
