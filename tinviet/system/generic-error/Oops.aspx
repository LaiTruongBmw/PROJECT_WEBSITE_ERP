<%@ Page Language="C#" AutoEventWireup="true"  Inherits="TSERP.Web.Default" %>
...
<link rel="stylesheet" type="text/css" media="all" href="js/impromptu/css.css" />
...
<div class="wrapper">
	...
	<div class="mainWrapper">
    	...
    	<div id="logo">
            <a href="http://mogoolab.com" title="Traffic 404 Custom Error Page">MogooLab</a></div>
    
        <div class="mainHolder">
            <div class="message">Oooops....we can’t find that page.</div>
            <!-- end .message -->
            <div class="errorNumber"><%=Request["code"] %></div> 
            <!-- end .errorNumber -->
            <!-- Search Form -->
            <div class="search">
