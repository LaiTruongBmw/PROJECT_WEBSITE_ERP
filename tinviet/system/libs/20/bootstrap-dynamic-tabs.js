			...
			function DynamicTabs() {
				...
				if ($horizontalContainer.parent('.dynamic-tabs-container').length === 0) {
					...
					$horizontalContainer.after(
						...
						+"<div class='toolbox'><a href='#' onclick='tserp.tab.PinOnOff(this)' data-tip='tooltip'  title='Pin'  class=''><i class='glyphicon glyphicon-pushpin'  status='1'  style='font-size: 1.4em;' ></i></a>" 
						+"<a href='#' onclick='tserp.tab.ReloadContent()'  data-tip='tooltip'  title='Reload' class=''><i class='fas fa-sync-alt' style='font-size: 1.4em;'></i></a>"
						+"<a href='#' data-tip='tooltip'  title='Help'  class=''><i class='fa fa-question-circle' style='font-size: 1.4em;'></i></a>"
						+"<a href='#' onclick='tserp.tab.RemoveTabCurr()' data-tip='tooltip'  title='Close'  class=''><i class='fa fa-window-close' style='font-size: 1.4em;'></i></a></div>"
					);
				}
