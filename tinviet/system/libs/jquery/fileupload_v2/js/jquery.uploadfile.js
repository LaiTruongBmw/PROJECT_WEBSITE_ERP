...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            acceptFiles: "*",
            fileName: "file",
            table_name: "TC_FSBINARY",
            srcTableName: "TC_FSBINARY",
            formData: false,
	   ...
	   this.startUpload = function () {
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var fileInputStr1 = "<input type='text' id='table_name' name='table_name' value='"+s.table_name+"'/>";
            var srcTableName  = "<input type='text' id='srcTableName' name='srcTableName' value='"+s.srcTableName+"'/>";
            $(fileInputStr1).appendTo(form);
            $(srcTableName).appendTo(form);
console.log(s);
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
            ...
            if(s.autoSubmit) {
            	console.log(options);
            	options.formData.append('tableName','TCO_BPPHOTO');
