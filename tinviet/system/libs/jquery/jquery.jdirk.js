...
*
* JQuery Extensions Basic Library Basic Functions Toolkit v1.0 beta
* Jquery.jdirk.js
* Secondary development of clouds
* Last Updated: 2014-06-26
*
* Dependencies: jquery 1.9.x / 2.x late
*
...
(function (window, $, undefined) {
    var version = "2014-04-24",
        ...
        //  Define generic tool methods to extend object primitives
        coreUtil = function () { return Object.apply(this, arguments); },

        //  Defines a null primitive geometry
        coreNullable = {},

        //  Defines a jQuery extension object primitive
        coreJquery = function () { return $.apply(this, arguments); },

        //  Defines the HTML5 tool component object primitives
        coreHtml5 = {};
    ...
    //  Test whether the object is a window (there may be Frame).
    coreUtil.isWindow = $.isWindow;

    //  Test whether the object is of type Boolean.
    coreUtil.isBoolean = function (obj) { return coreUtil.type(obj) == "boolean"; };

    //  Test whether the object is a string (String) type value.
    coreUtil.isString = function (obj) { return coreUtil.type(obj) == "string"; };

    //  Test whether the object is the date (Date) type value.
    coreUtil.isDate = function (obj) { return coreUtil.type(obj) == "date"; };

    //  Test whether the object is a regular expression (RegExp).
    coreUtil.isRegExp = function (obj) { return coreUtil.type(obj) == "regexp"; };

    //  Test whether the passed argument is a javascript object;
    coreUtil.isObject = function (obj) { return coreUtil.type(obj) == "object"; };

    //  Test whether the object is an array (Array).
    coreUtil.isArray = $.isArray;

    //  Test whether the object is a function.
    //	Note: In IE, functions such as 'alert' and DOM elements provided by the browser, such as 'getAttribute', are not considered functions.
    coreUtil.isFunction = $.isFunction;

    //  Test whether the object is a numeric or numeric format string.
    //	Method to check whether its parameters represent a value. If so, it returns true. Otherwise, it returns false. This parameter can be of any type.
    coreUtil.isNumeric = coreUtil.likeNumber = coreUtil.likeNumeric = $.isNumeric;

    //  Determine whether the object is a numerical type;
    coreUtil.isNumber = function (obj) { return coreUtil.type(obj) == "number"; };

    //	Test whether the object is empty object (does not contain any attributes).
    //	This method detects both the properties of the object itself and the properties inherited from the prototype (so there is no use of hasOwnProperty).
    coreUtil.isEmptyObject = $.isEmptyObject;

    //  Test whether the target is empty (not including any attributes of the null object, null, undefined, empty string, all spaces).
    //	This method detects both the properties of the object itself and the properties inherited from the prototype (so there is no use of hasOwnProperty).
    ...
    coreDate.toLongDateTimeString = function (date) {
        ...
        var year = date.getFullYear(),
            ...
            hoursArray = ["Midnight ", " early morning ", " morning" , " morning ", " noon ", " afternoon ", " evening ", " evening "],
            //hoursArray = ["午夜", "凌晨", "早上", "上午", "中午", "下午", "傍晚", "晚上"],
//            weekArray = ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"],
            weekArray = ["Sunday ", " Monday ", " Tuesday ", " Wednesday ", " Thursday ", " Friday ", " Saturday"],
            //monthArray = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
            quarterArray = ["Spring" , "Summer" , "Autumn" , "Winter"],
