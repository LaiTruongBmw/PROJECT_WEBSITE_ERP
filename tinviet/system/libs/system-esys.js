...
(function (esys) {
    var System = (function () {
        ...
        System.getSessionUserId = function () {
            return top.window['SYSTEM_USER_ID'];
        };
        System.getSessionUserName = function () {
            return top.window['SYSTEM_USER_NAME'];
        };
        System.getSessionEmployeePk = function () {
            return top.window['SYSTEM_EMPLOYEE_PK'];
        };
        System.getSessionOrgName = function () {
            return top.window['SYSTEM_ORG_NAME'];
        };
        System.getSessionRoleName = function () {
            return top.window['SYSTEM_ROLE_NAME'];
        };
        System.getSessionCodeAdminYn = function () {
            return top.window['SYSTEM_CODEADMIN_YN'];
        };
        System.getSessionDebugYn = function () {
            return top.window['SYSTEM_DEBUG_YN'];
        };
        System.getSessionCompanyPk = function () {
            return top.window['SYSTEM_COMPANY_PK'];
        };
        System.getSessionOrgPk = function () {
            return top.window['SYSTEM_ORG_PK'];
        };
        System.getSessionHrLevel = function () {
            return top.window['SYSTEM_HR_LEVEL'];
        };
        System.getSessionLang = function () {
            return top.window['SYSTEM_SESSION_LANG'];
        };
        System.getSessionEmpId = function () {
            return top.window['SYSTEM_EMP_ID'];
        };
        System.getSessionPositionName = function () {
            return top.window['SYSTEM_POSITION_NAME'];
        };
        System.getSessionAnnounceYn = function () {
            return top.window['SYSTEM_ANNOUNCE_YN'];
        };
        System.getSessionOrgId = function () {
            return top.window['SYSTEM_ORG_ID'];
        };
        System.getSessionUserPk = function () {
            return top.window['SYSTEM_USER_PK'];
        };
        System.getSessionBusPartnerPk = function () {
            return top.window['SYSTEM_BUSPARTNER_PK'];
        };
        System.getSessionPartnerName = function () {
            return top.window['SYSTEM_PARTNER_NAME'];
        };
        ...
        System.getClientPk = function () {
            return top.window['SYSTEM_CLIENT_PK'];
        };
        System.getAppUser = function () {
            return top.window['SYSTEM_APP_DBUSER'];
        };
        ...
        System.TranslateLanguage = function (objid, langfromto) {
            ...
            for (var prop in window) {
                if (!/webkitStorageInfo|webkitIndexedDB/.test(prop)) {
                    if (window[prop]) {
                        if (window[prop] instanceof esys.input.Label) {
                        ...
                        if (window[prop] instanceof esys.input.TextBox) {
                        ...
                        if (window[prop] instanceof esys.input.Icon) {
                        ...
                        if (window[prop] instanceof esys.input.Button) {
                        ...
                        if (window[prop] instanceof esys.contain.Tab2) {
                        ...
                        if (window[prop] instanceof esys.contain.Panel) {
                            var _panel = window[prop];
                            if (_panel) {
                                _panel.TranslateLanguage(langfromto);
                            }
                        }
                        if (window[prop] instanceof esys.grid.FlexGrid) {
                        ...
                        if (window[prop] instanceof esys.input.Label) {
                            ...
                            if (tmpCount == 0 && _label.text != '') {
                                tmpData = {
                                    ...
                                    "remark": "",
                                    "type_dic": "form",
                                    "_gwStatus_": esys.DataStatus.Added
                                };
        ...
        System.OpenModalNew = function (url, width, height, wtile, caller, fnclosecallback, opt) {
            ...
            var popupId = url.replace(/[`~!@#$%^&*()_|+\-=?;:'",.<>\{\}\[\]\\\/]/gi, '').replaceAll2(' ', '_') + '_' + this.getCurrentDate(new Date());
            url += "&popupId=" + popupId;
            var strHtml = '<div id="' + popupId + '" class="esys-control esys-content esys-popup esys-state-empty esys-state-invalid esys-state-focused" style="height: ' + height + 'px;  width: ' + width + 'px; display:none;" >' +
            ...
            if (opt) {
                if (opt.showCloseButton == false) {
                    ...
                    strHtml += '<button type="button" tabindex="-1" class="close esys-hide">×</button>';
                }
            }
            else {
                strHtml += '<button type="button" tabindex="-1" class="close esys-hide">×</button>';
            ...
            strHtml += '</h4>' +
                ...
                '<iframe class="iframe-placeholder" style="width:100%; height:100%;"   src="' + System.ctx + url + '"></iframe>' +
                '</div>';
            if (opt) {
                if (opt.showFooter) {
            ...
            var popup = new esys.input.Popup('#' + popupId, {
                hideTrigger: esys.input.PopupTrigger.None
            });
